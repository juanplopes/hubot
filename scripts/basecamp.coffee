...
module.exports = (robot) ->
	robot.hear /^show basecamp calendar( (.*))?$/i, (msg) ->
...
basecamp_request = (msg, url, handler) ->
  basecamp_key = "a46752b498a166d21c8977f6eba2a1ed2986b395" #process.env.HUBOT_BASECAMP_KEY
  auth = new Buffer("#{basecamp_key}:X").toString('base64')
  basecamp_url = "https://craftersstudio.basecamphq.com" # "http://#{process.env.HUBOT_BASECAMP_URL}.basecamphq.com"
